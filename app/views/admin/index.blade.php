							...
							<table class="table table-bordered table-striped">
								...
								<tbody>
									@if (count($customers) == 0)
										<b class="red">最近3天没有新注册会员</b>
									@endif
									@foreach ($customers as $customer)
									<tr>
										<td>{{$customer->username}}</td>
										<td>
											<b class="green">{{$customer->sex}}</b>
										</td>
										<td>
											<b class="blue">{{$customer->email}}</b>
										</td>
										<td>
											<b class="green">{{$customer->mobile}}</b>
										</td>
									</tr>
									@endforeach
							...
							<table class="table table-bordered table-striped">
								...
								<tbody>
									@if (count($restaurants) == 0)
										<b class="red">最近3天没有新加入餐厅</b>
									@endif
									{{count($restaurants)}}
									@foreach ($restaurants as $restaurant)
									<tr>
										<td>
											@if (!is_null($restaurant->restaurantname))
										...
										<td>
											@if (!is_null($restaurant->describe))
												{{$restaurant->describe}}
											@else
												<b class="green">暂未填写描述</b>
											@endif
										</td>
										<td>
											@if (!is_null($restaurant->mobile))
												{{$restaurant->mobile}}
											@else
												<b class="green">暂未填写手机号</b>
											@endif
										</td>
										<td class="hidden-480">
											@if (!is_null($restaurant->phone))
												{{$restaurant->phone}}
											@else
												<b class="green">暂未填写座机号码</b>
											@endif
										</td>
									</tr>
									@endforeach
