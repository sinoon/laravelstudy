					...
					<ul class="nav nav-list">
						...
						<li><!-- 网站活动 -->
							<a href="" class="dropdown-toggle">
								...
								<span class="menu-text"> 网站活动 </span>

								<b class="arrow icon-angle-down"></b>
							</a>

							<ul class="submenu">
								<li id="event"><!-- 查看所有网站活动 -->
									<a href="{{ asset('admin/event') }}">
										<i value="查看所有网站活动" class="icon-double-angle-right"></i>
										查看所有网站活动
									</a>
								</li>

								<li id="put-event"><!-- 提交网站活动 -->
									<a href="{{ asset('admin/put-event') }}">
										<i value="提交网站活动" class="icon-double-angle-right"></i>
										提交网站活动
									</a>
								</li>

								<li id="change-event"><!-- 修改网站活动 -->
									<a href="###">
										<i value="修改网站活动" class="icon-double-angle-right"></i>
										修改网站活动
									</a>
								</li>
							</ul>
						...
						<li><!-- 顾客管理 -->
							...
							<ul class="submenu">
								<li id="all-customer"><!-- 查看所有顾客 -->
									<a href="{{ asset('admin/all-customer') }}">
										<i value="查看所有顾客信息" class="icon-double-angle-right"></i>
										查看所有顾客
									</a>
								</li>

								<li id="control-customer"><!-- 修改顾客信息 -->
									<a href="{{ asset('admin/control-customer') }}">
										<i value="修改顾客信息" class="icon-double-angle-right"></i>
										修改顾客信息
									</a>
								</li>
							</ul>
						...
						<li> <!-- 餐厅管理 -->
							...
							<ul class="submenu">
								<li id="all-restaurant">
									<a href="{{ asset('admin/all-restaurant') }}">
										<i value="查看全部餐厅信息" class="icon-double-angle-right"></i>
										查看全部餐厅信息
									</a>
								</li>

								<li id="control-restaurant">
									<a href="{{ asset('admin/control-restaurant') }}">
										<i value="修改餐厅信息" class="icon-double-angle-right"></i>
										修改餐厅信息
									</a>
								</li>
							</ul>
							...
							<ul class="submenu">
								<li id="food"><!-- 查看所有顾客 -->
									<a href="{{ asset('admin/food') }}">
										<i value="查看所有菜品" class="icon-double-angle-right"></i>
										查看所有菜品
									</a>
								</li>

								<li id="control-food"><!-- 修改顾客信息 -->
									<a href="{{ asset('admin/control-food') }}">
										<i value="修改菜品信息" class="icon-double-angle-right"></i>
										修改菜品信息
									</a>
								</li>
							</ul>
						...
						<li><!-- 对于评论是不是要做现在还没有想好，所有这里暂时先不修改 -->
							<a href="" class="dropdown-toggle">
							...
							<ul class="submenu">
								<li id="lookcomment">
									<a href="{{ asset('admin/comment') }}">
										<i value="查看评论" class="icon-double-angle-right"></i>
										查看评论
									</a>
								</li>
							</ul>
						...
						<li><!--  -->
							...
							<ul class="submenu">
								<li id="check-ad">
									<a href="{{ asset('admin/check-ad') }}">
										<i value="查看广告" class="icon-double-angle-right"></i>
										查看广告
									</a>
								</li>

								<li id="control-ad"><!-- 修改顾客信息 -->
									<a href="{{ asset('admin/control-ad') }}">
										<i value="修改广告" class="icon-double-angle-right"></i>
										修改广告
									</a>
								</li>
							</ul>
