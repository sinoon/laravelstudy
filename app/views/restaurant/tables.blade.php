					...
					<ul class="nav nav-list">
						<li>
							<a href="#">
								...
								<span class="menu-text"> 总揽全局 </span>
							</a>
						</li>

						<li >
							<a href="/gofortest-profile" class="dropdown-toggle">
											...
											<table id="sample-table-2" class="table table-striped table-bordered table-hover">
												...
												<tbody>
													<tr>
														...
														<td class="hidden-480">
															<span class="label label-sm label-warning">状态</span>
														</td>
													...
													<tr>
														...
														<td class="hidden-480">
															<span class="label label-sm label-inverse arrowed-in">状态</span>
														</td>
