					...
					<div class="tab-pane" id="event">
						...
						<div class="media">
							<a class="pull-left" href="#">
								...
								@if (is_null($events->imgaddress))
									<img class="media-object img-thumbnail" width="100" src="{{ asset('img/暂无图片.jpg') }}" alt="...">
								@else
							...
							<tr>
								...
								<td colspan="4">
									...
									<div class="alert alert-warning">
										<span>正在配送中</span>
										<button value="{{$orders->oid}}" class="btn btn-success">
											收到外卖
										</button>
									</div>
									@endif
						...
						@else
							...
							<tr>
								<td colspan="3"> 
									...
									@endif
									@if ($orders->status == 3 && is_null($fullorders['needcomment']) )
										<td>
											<a href="{{ asset('food/comment/'.$fullorders['id'])}}" id="comment" class="btn btn-info">评价</a>
										</td>
									@endif
									@if ($orders->status == 3 && $fullorders['needcomment'] == 1)
										<td>
											<button id="comment" class="btn btn-primary">
												评价完成
											</button>
