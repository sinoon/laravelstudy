...
<div class="container">
	...
	<div class="row">
		<div class="col-md-6 col-md-offset-3">
			...
			<div class="row">
				<div class="col-md-12 text-center">
					{{Form::open(array('class' => 'form-horizontal','action' => 'OrderController@confirm_mobile'))}}
				<!-- <form class="form-horizontal" role="form"> -->
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<input type="" class="form-control" name="confirm_code" id="confirm_code" placeholder="">
						</div>
					</div>
				</div>
				<div class="row">
