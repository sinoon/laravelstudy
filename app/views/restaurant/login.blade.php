...
<html lang="zh-CN">
	<head>
		<meta charset="utf-8" />
		<title>快捷订餐管理系统 for 毕业设计 -- 餐厅后台登录页面</title>
	...
	<body class="login-layout">
											...
											<form>
												<fieldset>
													...
													<div class="clearfix">
														...
														<button id="restaurant-login" type="button" class="width-35 pull-right btn btn-sm btn-primary">
															<i class="icon-key"></i>
															登录
														</button>
													</div>
										...
										<div class="widget-main">
											...
											<form>
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input name="password_confirm" type="password" class="form-control" placeholder="重复密码" />
															<i class="icon-retweet"></i>
														</span>
													</label>

													<label class="block">
														<input name="aggrement" type="checkbox" class="ace" />
														<span class="lbl">
															我接受
															<a href="#">用户协议</a>
														</span>
													...
													<div class="clearfix">
														...
														<button id="register-submit" type="button" class="width-65 pull-right btn btn-sm btn-success">
															注册
		...
		<!-- remodel -->
			...
			<div id="alertremodel" class="remodal" data-remodal-id="register_submit">
				<h1>感谢您的加入，您的注册信息已经提交给后台</h1>
				<p>
					请耐心等待~
				</p>
				<a class="remodal-confirm" href="#">恩，知道了~</a>
...
<![endif]-->
		...
		<script src="{{ asset('js/register/restaurant-register.js') }}" ></script>
	</body>
</html>
